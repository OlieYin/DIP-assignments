...
def main():
    ...
    train_loader = DataLoader(train_dataset, batch_size=600, shuffle=True, num_workers=8)
    val_loader = DataLoader(val_dataset, batch_size=200, shuffle=False, num_workers=8)
